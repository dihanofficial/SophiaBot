...
from SophiaBot import BOT_ID, pbot as SophiaBot
from SophiaBot.helper_extra.aichat import add_chat, get_session, remove_chat
from SophiaBot.pyrogramee.pluginshelper import admins_only, edit_or_reply
...
@SophiaBot.on_message(
    filters.command("chatbot") & ~filters.edited & ~filters.bot & ~filters.private
)
@admins_only
async def kaj(_, message):
    global SophiaBot_chats
...
async def kaj(client, message):
    ...
    if chat_id in en_chats:
        ...
        pro = response
        try:
            await SophiaBot.send_chat_action(message.chat.id, "typing")
